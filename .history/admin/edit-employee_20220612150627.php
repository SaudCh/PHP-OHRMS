...
<body>
    ...
    <div class="container-fluid profile-body">
        <div class="row align-items-center justify-content-center">
            <div class="card col-11 col-md-9 my-4 py-4 cus-card">
                ...
                ?>
                        <form name="updateform" method="POST" action="./assets/includes/update-employee.includes.php" onsubmit="return validateform(this)" style="z-index: 10;position:relative;" class="mx-0 px-0 px-md-5 mx-md-5">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="number" name="salary" class="form-control" id="salary" value="<?= (int)$row['salary'] ?>">
    ...
    <script src="./assets/js/updateEmp.js"></script>
