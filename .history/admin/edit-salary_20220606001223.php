                ...
                ?>
                    ...
                    <div id="attendance-data">
                        ...
                        if ($present < $workdays - 3) {
                            echo '<p class="card-text p-0 m-0 mb-2">Salary: <span class="text-danger">' . $salary . '</span></p>';
                        } else {
                            echo '<p class="card-text p-0 m-0 mb-2">Salary: <span class="text-success">' . $salary - ($workdays - $present) . '</span></p>';
                        }
                        ?>
                        <p class="card-text p-0 m-0 mb-2">Salary: <?= $present ?></p>
