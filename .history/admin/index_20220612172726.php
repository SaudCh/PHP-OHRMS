    ...
    <div class="container-fluid my-5">
        <div class="row align-items-center justify-content-center">
            <div class="col-6 col-md-3">
                <div class="card">
                    <img src="../assets/images/manageEmp.png" class="card-img-top align-self-center mt-2" style="height: 100px;" alt="...">
                    <div class="card-body">
            ...
            <div class="col-6 col-md-3">
                <div class="card">
                    <img src="../assets/images/addEmp.svg" class="card-img-top align-self-center mt-2" style="width: 100px;" alt="...">
                    <div class="card-body">
            ...
            <div class="col-6 col-md-3">
                <div class="card">
                    <img src="../assets/images/manatten.svg" class="card-img-top align-self-center mt-2" style="width: 100px;" alt="...">
                    <div class="card-body">
