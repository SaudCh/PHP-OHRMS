            ...
            <div class="card col-11 col-md-9">
                ...
                ?>
                    ...
                    <div id="attendance-data">
                        ...
                        <?php
                        if ($present > $workdays) {
                            echo '<p class="card-text p-0 m-0 mb-2">Salary: <span class="text-danger">' . $row['salary'] . '</span></p>';
                        } else {
                            echo '<p class="card-text p-0 m-0 mb-2">Salary: <span class="text-success">' . $row['salary'] . '</span></p>';
                        }
                        ?>
