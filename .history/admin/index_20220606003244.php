...
<body>
    ...
    <div class="index-body">
        <div class="card">
            ...
            <a class="btn my-2 text-white" style="background-color: #fe9117;" href="add-attendance">Add Attendance</a>
            <a class="btn my-2 text-white" style="background-color: #fe9117;" href="employee">View Employees</a>
        </div>
    </div>
</body>
