    ...
    <div class="container-fluid profile-body">
        <div class="row align-items-center justify-content-center " style="min-height: 80vh;">
            <div class="card col-11 col-md-9 my-4 py-4 cus-card">
                ...
                ?>
                        <form name="updateform" method="POST" action="./assets/includes/update.includes.php" onsubmit="return validateupdateform(this)" style="z-index: 10;position:relative;" class="mx-0 px-0 px-md-5 mx-md-5">
                            <div class="mt-3">
