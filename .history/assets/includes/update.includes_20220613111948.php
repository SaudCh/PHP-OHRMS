...
if ($preEmail != $email) {
    ...
    if ($num == 1) {
        ...
        $sql = "UPDATE employee SET name ='$name',phoneNumber = '$phoneNumber', department = '$department', emailAddress = '$preEmail', address = '$address' ,gender = '$gender',tempMail	 = '$email',token = '$token' WHERE emailAddress = '$preEmail'";
