function validateupdateform(scope) {
    ...
    var adderr = document.getElementById("nameerr");
    var phoneerr = document.getElementById("passworderr");
    ...
    if (password == null || password == "") {
        phoneerr.innerHTML = "*Password Required";
        err = false;
    ...
    if (address == null || address == "") {
        adderr.innerHTML = "*Address Required";
        err = false;
    } else {
